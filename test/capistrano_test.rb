...
class CapistranoTest < Test::Unit::TestCase
  def setup
    ...
    HydraulicBrake::Capistrano.load_into(@configuration)
    @configuration.dry_run = true
  end

  should "define hydraulic_brake:deploy task" do
    assert_not_nil @configuration.find_task('hydraulic_brake:deploy')
  end

  should "log when calling hydraulic_brake:deploy task" do
    ...
    @configuration.find_and_execute_task('hydraulic_brake:deploy')
